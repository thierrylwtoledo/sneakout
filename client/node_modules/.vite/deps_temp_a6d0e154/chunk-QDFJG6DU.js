...
init_clsx_m();
init_useEventCallback();
var useEnhancedEffect = typeof window === "undefined" ? React7.useEffect : React7.useLayoutEffect;
function Ripple(props) {
  ...
  var _React$useState = React7.useState(false), leaving = _React$useState[0], setLeaving = _React$useState[1];
...
var TouchRipple = React8.forwardRef(function TouchRipple2(props, ref) {
  ...
  var _React$useState = React8.useState([]), ripples = _React$useState[0], setRipples = _React$useState[1];
  var nextKey = React8.useRef(0);
  var rippleCallback = React8.useRef(null);
  ...
  var ignoringMouseDown = React8.useRef(false);
  var startTimer = React8.useRef(null);
  var startTimerCommit = React8.useRef(null);
  var container = React8.useRef(null);
  React8.useEffect(function() {
    return function() {
      clearTimeout(startTimer.current);
    };
  }, []);
  var startCommit = React8.useCallback(function(params) {
    ...
    setRipples(function(oldRipples) {
      return [].concat(_toConsumableArray(oldRipples), [React8.createElement(Ripple_default, {
        key: nextKey.current,
        classes,
        timeout: DURATION,
        pulsate: pulsate2,
  ...
  var start = React8.useCallback(function() {
  ...
  var pulsate = React8.useCallback(function() {
    start({}, {
      pulsate: true
    });
  }, [start]);
  var stop = React8.useCallback(function(event, cb) {
    clearTimeout(startTimer.current);
  ...
  return React8.createElement("span", _extends({
    className: clsx_m_default(classes.root, className),
    ref: container
  }, other), React8.createElement(TransitionGroup_default, {
    component: null,
    exit: true
  }, ripples));
});
...
var ButtonBase = React9.forwardRef(function ButtonBase2(props, ref) {
  ...
  return React9.createElement(ComponentProp, _extends({
    ...
    React9.createElement(TouchRipple_default, _extends({
      ref: rippleRef,
      center: centerRipple
    }, TouchRippleProps))
  ) : null);
...
//# sourceMappingURL=chunk-QDFJG6DU.js.map
